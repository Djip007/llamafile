...
## accuracy with Mistral-Nemo-Instruct-2407:
...
```sh
GGML_USE_BACKEND_BF16='["FP8_E<x>M<y>_<z>",  "BF16"]' llamafile-perplexity \
 -f wikitext-2-raw/wiki.test.raw  -s 31337 -m Meta-Llama-3.1-8B-Instruct.BF16.gguf
```

FB16: Final estimate: PPL = 7.3210 +/- 0.04673
|   BF16  |    PPL   |    KLD   | top P   |
| ------: | -------: | -------: | ------: |
...
not realy good for this one.

```sh
GGML_USE_BACKEND_BF16='["FP8_E<x>M<y>_<z>",  "BF16"]' llamafile-perplexity \
 -f wikitext-2-raw/wiki.test.raw  -s 31337 -m Mistral-7B-Instruct-v0.3.BF16.gguf
```
...
|  E5M2_C | 6.202065 | 0.009957 |  95.171 |
